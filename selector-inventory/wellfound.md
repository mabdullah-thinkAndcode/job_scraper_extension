...
- Title selector(s): `TODO - inspect, site is React SPA (AngelList rebrand)`
...
## Notes
Formerly AngelList Talent. React SPA with client-side rendering; content script must wait for hydration (MutationObserver recommended). No verified public selector list found - inspect manually.
