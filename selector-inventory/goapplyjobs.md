...
## Notes
No public documentation found for this platform's DOM structure. Treat as a candidate for the generic fallback adapter first; build a dedicated adapter only after manual inspection.
